...
export default function Form() {
    ...
    return <form className="flex flex-col h-full gap-2 items-center py-4" onSubmit={handleSubmit} {...getRootProps()}>
        ...
        <div className="w-full max-w-lg">
            ...
            {isDragActive && 
                <div className={`absolute top-0 bottom-0 right-0 left-0 ${isDragAccept && 'bg-neutral/25 text-neutral'} ${isDragReject && 'bg-error/25 text-error-content'} z-[2] text-xl p-4`}>
                    <div className={`border border-dashed ${isDragAccept && 'border-neutral'} ${isDragReject && 'border-error'} border-8 w-full h-full grid place-items-center`}>
